...
(function languageToggle() {
  ...
  const ptToEn = {
    ...
    "Site institucional com demostracao dos servicos e cadastro de clientes.": "Business website showcasing services and enabling customer registration.",
    "Demonstracao": "Showcase",
    "Landing page com o intuito de mostrar o servico da loja.": "Landing page designed to showcase the store's services.",
    "Servicos": "Services",
    ...
    "Integral": "Full-time",
    "atual": "present",
    "09.2026 - atual · 1m": "09.2026 - present · 1 mo.",
    ...
    "Desenvolvimento de Sites e automacoes": "Website and automation development",
    "Criacao de landing-pages | Bots | Automacoes | Sites institucionais": "Landing pages | Bots | Automations | Business websites",
    "Suporte": "Support",
    "Manutencao · Suporte · Automacao": "Maintenance · Support · Automation",
    "Forneco total suporte ao site e cuido das automacoes para facilitar o dia a dia da empresa.": "I provide complete website support and manage automations to make the company's daily work easier.",
